...
plot(T6.19$`Snout Vent Length (cm)`, T6.19$`Weight (kg)`,
     ...
     pch = 16,
     col = ifelse(T6.19$Gender == "Female", "red", "blue"))
...
femaleBar <- colMeans(T6.19_female_numerical, na.rm = TRUE)
maleBar <- colMeans(T6.19_male_numerical, na.rm = TRUE)
#x_bar


# Tilføj stikprøvegennemsnit til plot
points(x_bar[1], x_bar[2], pch = "X", col = "black", cex = 2)
points(femaleBar[1], femaleBar[2], pch = "X", col = "green", cex = 2)
points(maleBar[1], maleBar[2], pch = "X", col = "orange", cex = 2)

legend("topleft", legend = c("56 Observationer", "Male", "Female", "Stikprøvegennemsnit", "Male Stikprøvegennemsnit", "Female Stikprøvegennemsnit"),
       col = c("black", "blue", "red", "black","orange","green"),pch = c(19, 19, 19, 4, 4, 4),
...
legend("topleft", legend = c("Hotelling’s T²-ellipse", "Bonferroni"),
