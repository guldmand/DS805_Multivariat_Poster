...
## 5. Covariance Comparison (Box's M Alternative)
```{r}
detS1 <- det(S1)
detS2 <- det(S2)
detS1; detS2

# Ratio of determinants (indicative, not a formal test)
det_ratio <- detS1 / detS2
log_ratio <- abs(log(det_ratio))
log_ratio

# Compare diagonal (variance) elements
S1; S2
```
